...
function Home(){
    return(
        ...
        <div className="flex flex-col items-center justify-center md:mr-120  md:p-0 mt-10">
            <button className="font-bold bg-red-500 p-3 w-32 md:w-40 hover:bg-red-600 hover:text-white transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 size-12 rounded-sm">Contact</button>
        </div>
        </>
    )
}
